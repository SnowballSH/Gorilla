...
func TestMisc(t *testing.T) {
	...
	n = lexer.next()
	assert.Equal(t, token.DbEq, n.Type)
	assert.Equal(t, "==", n.Literal)

	n = lexer.next()
	assert.Equal(t, token.Neq, n.Type)
	assert.Equal(t, "!=", n.Literal)

	n = lexer.next()
	assert.Equal(t, token.Not, n.Type)
	assert.Equal(t, "!", n.Literal)
	...
	n = lexer.next()
	assert.Equal(t, token.Larger, n.Type)
	assert.Equal(t, ">", n.Literal)

	n = lexer.next()
	assert.Equal(t, token.Smaller, n.Type)
	assert.Equal(t, "<", n.Literal)

	n = lexer.next()
	assert.Equal(t, token.LargerEq, n.Type)
	assert.Equal(t, ">=", n.Literal)

	n = lexer.next()
	assert.Equal(t, token.SmallerEq, n.Type)
	assert.Equal(t, "<=", n.Literal)
}
...
func TestBinOp(t *testing.T) {
	...
	n = lexer.next()
	assert.Equal(t, token.Percent, n.Type)
	assert.Equal(t, "%", n.Literal)
